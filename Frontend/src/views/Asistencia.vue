...
export default {
  ...
  setup() {
    ...
    onMounted(async () => {
      var AsistenciaIcon = function (cell, formatterParams, onRendered) {
      ...
      table = new Tabulator("#example-table", {
        ...
        columns: [
          ...
          {
            title: "VerAsistencia",
            titleFormatter: AsistenciaIcon,
            formatter: AsistenciaIcon,
            tooltip: "Ver asistencia del curso",
            width: 70,
            hozAlign: "center",
            headerHozAlign: "center",
            headerSort: false,
            cellClick: async function (e, cell) {
              store.dispatch("setFecha", { fecha: '' });
              await store.dispatch("setCursoPac", { cursoPac: cell.getRow().getData()});
              router.push("asistenciacurso");
            },
          },
        ],
      });
...
<template>
  <div class="home">
    ...
    <h1>Seleccione un curso para ver la asistencia de este</h1>
    <br />
